...
public class TaskController {
    ...
    public ResponseEntity<List<TaskResponseDto>> getTasksInProgress(){
    ...
    public ResponseEntity<List<TaskResponseDto>> getTasksCompleted(){

        return ResponseEntity.ok(taskService.getTasksCompleted());
    ...
    @PostMapping()
    public ResponseEntity<TaskResponseDto> createTask(@RequestBody TaskRequestDto taskRequestDto) throws URISyntaxException {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<TaskResponseDto> makeCompleted(@PathVariable Long id){
